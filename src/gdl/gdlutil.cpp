...
int GdlContainer::registerRoutine( IDL_SYSFUN_DEF2 def, int is_function, info_func info, void_func cleanup ) {
...
void GdlContainer::cleanup( void ) {
...
void GdlContainer::info( int argc, IDL_VPTR* argv, char* argk ) {
