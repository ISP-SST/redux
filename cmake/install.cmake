...
if(WIN32)
    ...
    endforeach()
    list(APPEND CMAKE_LIBRARY_PATH $${}{DLL_PATHS} $${}{CMAKE_INSTALL_PREFIX}/bin)
        ...
        if(NOT EXISTS "$${}{CMAKE_INSTALL_PREFIX}/bin/$${}{dep_name}")
            ...
            if(NOT "$${}{libpath}" MATCHES "$${}{WINPATH}")
                if(EXISTS "$${}{libpath}")
                    ...
                    file(INSTALL $${}{dep_realpath} DESTINATION "$${}{CMAKE_INSTALL_PREFIX}/bin")
                    # can we avoid coying to build-dir by adding "$${}{CMAKE_INSTALL_PREFIX}/bin" to environment for test targets ??
                    ...
                    if(NOT "$${}{dep_name}" STREQUAL "$${}{inst_name}")
                        file(RENAME "$${}{CMAKE_INSTALL_PREFIX}/bin/$${}{inst_name}" "$${}{CMAKE_INSTALL_PREFIX}/bin/$${}{dep_name}")
                    endif()
