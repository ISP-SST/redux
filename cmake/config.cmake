...
option( RDX_TRACE_MEM "Enable tracing of (de-)allocations of shared_ptr types" OFF )
...
option( RDX_TRACE_PROC "Enable tracing of Solver/TmpStorage/SubImage objects" OFF )
...
if( RDX_TRACE_ALL )
    ...
    set( RDX_TRACE_MEM   ON )
    set( RDX_TRACE_NET   ON )
    set( RDX_TRACE_JOB   ON )
    set( RDX_TRACE_PARTS ON )
    set( RDX_TRACE_PROC ON )
endif()

if( RDX_TRACE_ARRAY OR RDX_TRACE_CACHE OR RDX_TRACE_FILE OR RDX_TRACE_MEM OR RDX_TRACE_NET OR RDX_TRACE_JOB OR RDX_TRACE_PARTS OR RDX_TRACE_PROC )
    set( RDX_TRACE True )
endif()
